...
const Table: React.FC<TableProps> = ({ history }) => {
  return (
    <div className="container p-2 mx-auto sm:p-4 text-gray-100 bg-[#7765F3]">
      <h2 className="mb-4 text-2xl font-semibold leading-normal">Recent Transactions</h2>
        ...
        <table className="min-w-full text-xs">
          ...
          <tbody>
            {history.map((history, i) => (
              <tr key={history.historyId || i + 1} className="border-b border-opacity-20 border-gray-700 bg-[#27272A]">
                <td className="p-3">
